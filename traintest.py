...
df = pd.read_csv(os.path.join('jigsaw-toxic-comment-classification-challenge', 'train.csv', 'anxious2.csv'), encoding='latin-1')
df.head()
...
try:
    ...
    model.save(filename)
translated = "an anime girl surrounded by balloons, magical colored theme, kawaii decora rainbowcore, magical fairy background, cat theme banner, official character illustration, sparkling magical girl, decora inspired illustrations, airy theme, screenshot from a 2012s anime, clematis theme banner, decora inspired, witchlight carnival, my dress up darling anime, official artwork"
print("All")
filename = 'model/all2.h5'
history = tf.keras.models.load_model(filename)
